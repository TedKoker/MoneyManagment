#pragma checksum "C:\Users\97252\source\repos\MoneyManagment\MoneyManagment\Views\Personal\newOfAddingInfo.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6336f94a9d30e1438c89948f5d0499ebd4924bec"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6336f94a9d30e1438c89948f5d0499ebd4924bec", @"/Views/Personal/newOfAddingInfo.cshtml")]
...
#line hidden
    ...
    <div class=""box-hidde"" id=""box"">
        ...
        <table id=""formTable"" class=""table"" style=""background-color:white"">
            ...
            EndContext();
            BeginWriteAttribute("value", " value=\"", 2476, "\"", 2520, 1);
#line 88 "C:\Users\97252\source\repos\MoneyManagment\MoneyManagment\Views\Personal\newOfAddingInfo.cshtml"
WriteAttributeValue("", 2484, DateTime.Now.ToString("dd/MM/yyyy"), 2484, 36, false);

#line default
#line hidden
            EndWriteAttribute();
            BeginContext(2521, 8948, true);
            WriteLiteral(@"/>              
                </td>
            </tr>
            <tr>
  ...
  ");
            WriteLiteral(@"          dateInForm = dateInForm.slice(document.getElementById(""month"").value.length + 1,dateInForm.length);
        ...
        function updateDate(){
            ...
            if (day.getAttribute('style') === null && month.getAttribute('style') === null && year.getAttribute('style') === null) {
                if (dateOfDate <= new Date()) {
                    if (month.value.length !== 2) correctDateNember(month);
                    ...
                    day.setAttribute(""style"", ""background-color: red"");
                    month.setAttribute(""style"", ""background-c");
        ...
        function correctDateNember(number){
            ...
            if (number.length < 2) {
                ...
                for (let i = 0; i < number.length; i++) {
                    if (number[i] !== 0) correctNumber = """" + correctNumber + number;
                }
            }
   ...
   ");
        ...
        function AddToList(element) {
            ...
            addButton.setAttrib");
            WriteLiteral(@"ute(""style"", ""display:inline"");
        ...
        function SendToDatabase(element) {
            ...
            if (document.getElementById(""expender"").checked)
                expende");
            WriteLiteral(@"rOrIncome = ""expender"";
            else
...
");
            EndContext();
#line 295 "C:\Users\97252\source\repos\MoneyManagment\MoneyManagment\Views\Personal\newOfAddingInfo.cshtml"
}
